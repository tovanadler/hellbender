...
public final class UtilsUnitTest extends BaseTest {
    ...
    @Test
    public void testarrayFromArrayWithLength(){
        Assert.assertEquals(new byte[]{0}, Utils.arrayFromArrayWithLength(new byte[]{0,1,2}, 1));
        Assert.assertEquals(new byte[]{1, 1, 1}, Utils.arrayFromArrayWithLength(new byte[]{1}, 3));
        Assert.assertEquals(new byte[]{0,1,2,0}, Utils.arrayFromArrayWithLength(new byte[]{0,1,2}, 4));
    }

    @Test
    public void testfillArrayWithByte() {
        final byte[] arr = new byte[]{0, 1, 2};
        Utils.fillArrayWithByte(arr, (byte)3);
        Assert.assertEquals(new byte[]{3,3,3}, arr);
    }
