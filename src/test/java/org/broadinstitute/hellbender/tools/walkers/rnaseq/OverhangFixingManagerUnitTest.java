...
public class OverhangFixingManagerUnitTest extends BaseTest {
    ...
    public void testCleanSplices() {
        ...
        final OverhangFixingManager manager = new OverhangFixingManager(null, null, hg19GenomeLocParser, hg19ReferenceReader, 10000, 1, 40, false);
    ...
    public void testUnmappedReadsDoNotFail() {
        ...
        final MutableRead read = ArtificialReadUtils.createRandomRead(100);
        read.setName("foo");
        read.setCigar("*");
        read.setIsUnmapped();

        // try to add it to the manager
        final OverhangFixingManager manager = new OverhangFixingManager(null, null, null, null, 100, 1, 30, false);
