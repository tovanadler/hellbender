...
public class ReadTransformerTest {
    ...
    public void testAndThen( final MutableRead read ) {
    ...
    @Test(dataProvider = "UnmodifiedReadDataProvider")
    public void testCompose( final MutableRead read ) {
    ...
    @Test(dataProvider = "UnmodifiedReadDataProvider")
    public void testAndChain( final MutableRead read ) {
    ...
    @Test(dataProvider = "UnmodifiedReadDataProvider")
    public void testMixedChain( final MutableRead read ) {
    ...
    @Test(dataProvider = "UnmodifiedReadDataProvider")
    public void testIdentity( final MutableRead read ) {
