...
public class ArtificialReadIterator implements Iterator<MutableRead>, Iterable<MutableRead> {
    ...
    // the next record
    protected MutableRead next = null;
