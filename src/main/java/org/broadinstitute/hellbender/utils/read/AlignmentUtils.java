...
public final class AlignmentUtils {
    ...
    /**
     * @see #getMismatchCount(Read, byte[], int, int, int) with startOnRead == 0 and nReadBases == read.getLength()
     */
    public static MismatchCount getMismatchCount(Read r, byte[] refSeq, int refIndex) {
     ...
     */
    @SuppressWarnings("fallthrough")
    public static MismatchCount getMismatchCount(Read r, byte[] refSeq, int refIndex, int startOnRead, int nReadBases) {
     ...
     */
    public static int getNumAlignmentBlocks(final Read r) {
     ...
     */
    public static int getNumAlignedBasesCountingSoftClips(final Read r) {
        int n = 0;
        final Cigar cigar = r.getCigar();
        if (cigar == null) return 0;
     ...
     */
    public static int getNumHardClippedBases(final Read r) {
        if ( r == null ) throw new IllegalArgumentException("Read cannot be null");
     ...
     */
    public static int calcNumHighQualitySoftClips( final Read read, final byte qualThreshold ) {
