...
public class SplitReads extends ReadWalker {
    ...
    private Map<String, SAMFileReadWriter> outs = null;
     ...
     */
    private Map<String, SAMFileReadWriter> createWriters(final List<ReaderSplitter<?>> splitters) {
        final Map<String, SAMFileReadWriter> outs = new HashMap<>();
        ...
        addKey(splitKeys, 0, "", key -> {
            ...
            outs.put(key, new SAMFileReadWriter(samFileWriterFactory.makeWriter(samFileHeaderOut, true, outFile, referenceArguments.referenceFile)));
        });
     ...
     */
    private String getKey(final List<ReaderSplitter<?>> splitters, final Read record) {
