...
public abstract class LocalAssemblyEngine {
    private final static Logger logger = LogManager.getLogger(LocalAssemblyEngine.class);
     ...
     */
    protected abstract List<AssemblyResult> assemble(List<SAMRecord> reads, Haplotype refHaplotype, List<Haplotype> givenHaplotypes);
