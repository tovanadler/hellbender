...
import org.broadinstitute.hellbender.tools.walkers.haplotypecaller.LocalAssemblyEngine;
...
public class ReadThreadingAssembler extends LocalAssemblyEngine {
    ...
    @Override
    public List<AssemblyResult> assemble(final List<SAMRecord> reads, final Haplotype refHaplotype, final List<Haplotype> givenHaplotypes) {
     ...
     */
    protected AssemblyResult createGraph(final List<SAMRecord> reads,
